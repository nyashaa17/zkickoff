                ...
                {liveMatches.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-2 justify-center w-full max-w-sm">
                      <Link href="/" className="px-5 py-2.5 bg-brand-green hover:bg-brand-green-hover text-neutral-950 font-display text-xs font-black rounded-xl flex items-center justify-center gap-1.5 transition-all shadow-md shadow-brand-green/20">
