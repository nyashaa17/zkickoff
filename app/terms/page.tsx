      ...
      <div className="bg-white dark:bg-[#141417] border border-neutral-200/50 dark:border-neutral-800 rounded-3xl p-6 md:p-10 shadow-xs max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-xs md:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">1. Terms Acceptance</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">2. Scope of Service</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">3. Non-Hosting &amp; Media Disclaimer</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">4. Prohibited Personal Conduct</h2>
            <p>
          ...
          <section className="space-y-2 pb-4">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">5. Right to Amends</h2>
            <p>
