...
export default function DMCAPage() {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10">
      ...
      <div className="bg-white dark:bg-[#141417] border border-neutral-200/50 dark:border-neutral-800 rounded-3xl p-6 md:p-10 shadow-xs max-w-4xl mx-auto">
        <div className="border-b border-neutral-150 dark:border-neutral-800 pb-6 mb-8">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] font-mono font-black text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">
          ...
          <h1 className="text-xl md:text-3xl font-display font-black text-neutral-900 dark:text-white mt-2 tracking-tight">
            DMCA Policy
          </h1>
        ...
        <div className="space-y-6 text-xs md:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">1. DMCA Compliance</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">2. Our Role</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">3. Reporting Copyright Infringement</h2>
            <p>
            ...
            <div className="bg-neutral-50/70 dark:bg-neutral-800/40 border border-neutral-250/40 dark:border-neutral-800 rounded-2xl p-4 md:p-5 mt-3 space-y-2.5">
              <h3 className="font-semibold text-neutral-800 dark:text-neutral-200 text-xs uppercase tracking-wider">3.1 Required Information</h3>
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-neutral-500 dark:text-neutral-400 font-medium">
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">4. Counter-Notification</h2>
            <p>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-xs font-semibold text-neutral-500 dark:text-neutral-400">
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">5. Repeat Infringers</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">6. Contact for DMCA Notices</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">7. Processing Time</h2>
            <p>
              We aim to process and act upon valid DMCA takedown notices within <span className="text-neutral-800 dark:text-neutral-200 font-bold">24-48 hours</span> of receipt. Please allow reasonable time for legal review and administrative action.
            </p>
          </section>

          <section className="space-y-2 pb-4">
            <h2 className="text-sm font-display font-bold text-neutral-900 dark:text-white">8. False Claims</h2>
