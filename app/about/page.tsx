    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10">
      ...
      <div className="bg-white dark:bg-[#141417] border border-neutral-200/50 dark:border-neutral-800 rounded-3xl p-6 md:p-10 shadow-xs max-w-4xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h1 className="text-xl md:text-3xl font-display font-black text-neutral-900 dark:text-white mt-3 mb-4 tracking-tight">
            About ZimKickOff
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="p-5 border border-neutral-100 dark:border-neutral-800 rounded-2xl bg-neutral-50/50 dark:bg-neutral-800/40">
            <Tv className="w-8 h-8 text-zim-green mb-3.5" />
            <h3 className="font-display font-extrabold text-neutral-900 dark:text-white mb-2 text-sm md:text-base">
          ...
          <div className="p-5 border border-neutral-100 dark:border-neutral-800 rounded-2xl bg-neutral-50/50 dark:bg-neutral-800/40">
            <Cpu className="w-8 h-8 text-neutral-950 dark:text-brand-green mb-3.5" />
            <h3 className="font-display font-extrabold text-neutral-900 dark:text-white mb-2 text-sm md:text-base">
        ...
        <div className="border-t border-neutral-150 dark:border-neutral-800 pt-8 text-center bg-neutral-50/50 dark:bg-neutral-800/40 rounded-2xl p-6 border border-neutral-200/40 dark:border-neutral-800">
